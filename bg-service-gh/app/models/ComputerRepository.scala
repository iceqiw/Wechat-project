...
object Page {
  implicit val residentWrites3 = Json.writes[Computer]
  implicit val residentWrites5 = Json.writes[Company]
  implicit val residentWrites = Json.writes[(Computer, Option[Company])]
  implicit val pageWrites = Json.writes[Page[(Computer, Option[Company])]]
}
